...
$fc1_id         = KKW_ThemeLangManager::get_page_by_id( $fc1_id ); // Get the post in the right language.
if ( $fc1_id ) {
...
$fc2_id         = KKW_ThemeLangManager::get_page_by_id( $fc2_id ); // Get the post in the right language.
if ( $fc1_id ) {
...
$fc3_id         = KKW_ThemeLangManager::get_page_by_id( $fc3_id ); // Get the post in the right language.
